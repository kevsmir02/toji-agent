...
4. **Next Steps** — Suggest the next 2-3 actionable tasks and prepare a summary paragraph for the planning doc.
5. **Next Command Guidance** — Return to `/execute-plan` for remaining work. When all implementation tasks are complete, run `/check-implementation`.
